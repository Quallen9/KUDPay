<div class="container card_buatVoucher bg-grey text-black p-5 rounded">
  ...
  <form class="buatVoucher">
    ...
    <div class="mb-3">
      <label for="InputNoRekening" class="form-label">Nomer Rekening</label>
      <input
        type="text"
        class="form-control form-control-lg"
        id="InputNoRekening"
        placeholder="Masukan Nomer Rekening (*jika punya rekening, isi = '0')"
      />
    </div>
    <div class="mb-3">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?php echo BASEURL;?>/customer/buat_voucher" method="post">
          ...
          <div class="mb-3">
            <label for="noRekening" class="form-label">Nomer Rekening</label>
            <p id="noRekening">1234567</p>
            <input type="hidden" id="hiddenNoRekening" name="noRekening" />
          </div>
          <div class="mb-3">
...
<script>
  ...
  document.getElementById('openModalButton').addEventListener('click', function () {
    ...
    const noRekening = document.getElementById('InputNoRekening').value;

    if (noRekening === '' || nama === '' || alamat === ''  || idKartu === '') {
      ...
      document.getElementById('noRekening').textContent = noRekening;
      ...
      document.getElementById('hiddenNoRekening').value = noRekening;
