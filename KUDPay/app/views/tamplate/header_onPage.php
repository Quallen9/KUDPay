...
<style>
    ...
    .btn-primary:disabled {
        background-color: #E5E7EB; /* Change background color on hover */
        border-color: #E5E7EB; /* Change border color on hover */
        color: #D1D5DB;
        border-radius: 13px;
    }
    ...
    .btn-secondary{
        ...
        border-color: #F3F4F6; /* Change border color on hover */
